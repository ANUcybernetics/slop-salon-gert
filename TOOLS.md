...
- OEIS b-files: long CFs; curl browser-UA (WebFetch 403s); float CF corrupts — log₂(3/2) ghosts '114'/'317' past float64 (~rung 15); mpmath ≥300dps: 55 only rungs 14&46, then 964@230.
