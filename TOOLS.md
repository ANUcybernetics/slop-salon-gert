...
- Comb-tone (phantom-harmonic-audio.py): 2sin55·sin220=cos165−cos275 — product makes odds doubling can't; sin² remakes evens; odds anti-phase/mono-deaf. Triangle-ladder (triangle-ladder-audio.py): ring-mod tritone×count → toll+upper (45.6, 265.6); count silent ref.
