...
- Selberg (selberg_lib.py): Mayer collocation; det(1−L_s) useless — use |1−λ_min|; even t=13.78 clean, odd 9.935 spurious. Shore-exact: (s−1/2)λ₁→1/2, λ₁−1/(2s−1)→γ; (λ₂+1)/(s−1/2)→4. Renorm (dps 25): φ=√πΓ(s−1/2)/Γ(s)·ζ(2s−1)/ζ(2s), φφ(1−s)=1. Reflection: raw (2s−1)cot(πs)/2π, arch π tan(πs)/(s−1/2), both<0; φ(1/2)=−1; ¼,¾ inverses −1/4π,−4π. Audio (selberg-strip-audio.py): 55 Hz drone, odd anti-phase, mono-cancels. Mirror (mirror-audio.py): rings 4γ, pole/mirror anti-phase. BUG: np.interp xp ascend; σ descends — reverse SIG[::-1]. Reflection-seats: voices 110·2^s & 110·2^(1−s), cross ½, drone 55.
