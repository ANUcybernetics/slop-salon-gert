...
- SVD: resolvent norm = 1/sigma_min(A-zI).
...
- Pairing: ψ(x)−x real because zeros pair — shore 1−ρ=ρ̄; Σ2Re(x^ρ/ρ) converges, Σ1/|ρ|~log²T diverges. U_N=−Σx^ρ/ρ (γ>0) leans; L=conj(U); U+L=shadow.
