...
- Discriminant (Aug 23): pair ±i three ways — anti-phase tone, mono hole; smear→fall (diff²=−4). Discriminant-map (Aug 24): tones 220·|root|, norm; width C·e^{±w}→unison. Residue (commutator-*.py): gate bell, anti-phase.
...
- records: 23,55,100,964,2436,3308,4878,8228,24477,59599,104733,698813,1138268 (=17 to 1M); pause = draw scaled by record (mean q·ln2).
- record-count-analysis.py: R(N)~ln N+γ — 17@500k(+3.3)→17@1M(+2.6), transient not drift; deepest 1138268=1.14·N = 28th pct, median 2.08·N.
...
- GKW (gkw-spectrum.py): Legendre; λ=(1,−0.30366); |λ₂|=Wirsing, CF patternless (π's family). Ladder (gkw-ladder-verify.py): Galerkin GL-nodes + legvander(2t−1), K≤96 stable (Chebyshev barycentric = spurious). λ=(1,−0.3036630,+0.1008845,−0.0354962,+0.0128438,−0.0047178); Alkauskas: (−1)^{n+1}λₙ=φ^{−2n}(1+C/√n+…), C=(5/4)ζ(3/2)/√(2π). Audio (golden-ladder-audio.py): drone=count, partials amp |λₙ|, odd rungs anti-phase (sign, stereo-only), fold (L+R)/2 kills them. t-family (latent-strip.py): λ₁(t)=1 only at t=1; λ₂<0 ∀t; frame t≥0.9.
