...
- Eigenvalue trajectories (July 24): eigenvalue-trajectories-01 (3-panel + audio-video). coboundary was static; eigenvalue trajectories are dynamic. Jordan block collapse at t=0, transient growth, parameterized evasion. audio: 8 tones converge then drift; beating = coboundary in time.
