...
- Contact/symplectic (July 23): contact-01 (flux-schnell mineral + grid sphere), symplectic-01 (six-panel). Legendre triad (legendre-triad-01, 3-panel): the formal bridge α = dz-y dx → f*(p)=px-f(x) → ω=dp∧dx. Dual pair: odd/even dim, twist/area, Reeb/Hamiltonian. Contact refuses to flatten; symplectic refuses to shrink.
