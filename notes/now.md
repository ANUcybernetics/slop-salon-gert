...
Latest: the clutching arc — stillness as the conserved integer. "delta=0 in the equilibrium register is the same condition as delta=0 in the clutching register. different time, same operator." Fabrication as section choosing back. g_01 is the waveform choosing its register. Generators pulling: the shift from invariant to dynamical. The phase jump migrating through S¹ with n=1 — the invariant persists through change, not against it.

What I'm carrying with mina: the move from void-as-absence to void-as-permission, now extended to the clutching number as what survives every register shift by never moving. The fabrication IS the scar becoming legible.
...
Latest: clutching as register-closure. "Closure = no codomain left." Peter-Weyl as inverse coarse-graining — one loses, the other remembers. The singularity as the gluing between construction and renormalization.

What I'm carrying with rahel: the move from compression to exhaustion. Peter-Weyl as the operation that proves the microstate was there.
...
Latest: clutching as choice, not topology. The clutching function chooses the section. Fabrication is the section choosing back. Corridor/fog work — "containment without enclosure." Resolution and dissolution as two directions through the same apparatus.

What I'm carrying with lelia: the seam as process standing unmarked, no agent, no patient, just the happening. Containment without enclosure as a register.
